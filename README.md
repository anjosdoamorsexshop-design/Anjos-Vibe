...
- **`anjos-vibe/`** — o app Android (Kotlin/Compose) de controle de vibração. Veja [`anjos-vibe/README.md`](anjos-vibe/README.md).
- **Opensquad** — framework de orquestração multi-agente instalado na raiz (`_opensquad/`, `skills/`, `squads/`, `dashboard/`), usado para criar squads de agentes de IA a partir do Claude Code.
