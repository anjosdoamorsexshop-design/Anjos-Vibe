...
object BuiltInPatterns {
    ...
    val ONDA = Pattern(
        ...
        durationMs = 4000,
        builtIn = true,
        points = ramp(0f, 1f, 8, 0f, 0.5f) + ramp(1f, 0f, 8, 0.5f, 1f)
    )
    ...
    val ESCALADA = Pattern(
        ...
        durationMs = 12000,
        builtIn = true,
        points = ramp(0.15f, 1f, 20, 0f, 0.92f) + listOf(Point(0.95f, 0f), Point(1f, 0f))
    )
    ...
    val PROVOCACAO = Pattern(
        ...
        builtIn = true,
        points = listOf(
            Point(0f, 0f), Point(0.05f, 0.66f), Point(0.18f, 0.66f),
            Point(0.2f, 0f), Point(0.38f, 0f), Point(0.4f, 1f),
            Point(0.52f, 1f), Point(0.54f, 0f), Point(0.72f, 0f),
            Point(0.74f, 0.33f), Point(0.86f, 1f), Point(0.95f, 1f),
